...
featured_cards.forEach((card)=>{
    ...
    card.addEventListener('click',()=>{
        ...
        const clicked = card.childNodes[3].textContent
        const product = featured_prodList.filter(obj => Object.values(obj).some(val => val.includes(clicked)))
...
top_cards.forEach((card)=>{
    ...
    card.addEventListener('click',()=>{
        ...
        const product = top_prodList.filter(obj => Object.values(obj).some(val => val.includes(clicked)))
